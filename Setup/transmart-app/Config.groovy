...
com.recomdata.largeLogo = "umg.jpg"

// application logo to be used in the search page
com.recomdata.smallLogo="umg.jpg"

// contact email address
com.recomdata.contactUs = "mi.translationaleforschung@med.uni-goettingen.de"

// site administrator contact email address
com.recomdata.adminEmail = "mi.translationaleforschung@med.uni-goettingen.de"

// application title
com.recomdata.appTitle = "UMG tranSMART v" + org.transmart.originalConfigBinding.appVersion
...
grails { plugin { springsecurity {
    ...
    if (oauthEnabled) {
        ...
        filterChain.chainMap = [
                ...
                '/transmart-rest-api-version': 'none', // TODO: fehlt auf transmart01
                '/**': [
                        'JOINED_FILTERS',
